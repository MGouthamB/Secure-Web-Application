...
def register(request):
    try:
        ...
        profile.Hmac = hmac.new(settings.SECRET_KEY.encode('utf-8'),
                                str(profile.email + "-" + profile.password).encode('utf-8'), hashlib.sha256).hexdigest()
...
def get_otp(request):
  ...
  <div style="margin:50px auto;width:70%;padding:20px 0">
    <div style="border-bottom:1px solid #eee">
      <a href="" style="font-size:1.4em;color: #00466a;text-decoration:none;font-weight:600">Groziit</a>
    </div>
    <p style="font-size:1.1em">Hi,</p>
    <p>Use the following OTP to complete your Sign Up procedures. OTP is valid for 1 minute</p>
